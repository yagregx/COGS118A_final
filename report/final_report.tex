...
Tables \ref{table-split-0.2_t}, \ref{table-split-0.5_t}, \ref{table-split-0.8_t} show the test accuracy of each classifier on three different datasets. Due to missing prediction data during the runs, F1 scores could not be computed for some models. 
...
LogisticRegression  & 0.982 & \textbf{0.991} & 0.979 & 0.968 \\
SVM                 & \textbf{0.983} & 0.988 & \textbf{0.981} & \textbf{0.970} \\
\end{tabular}
\end{center}
\end{table}
...
LogisticRegression  & \textbf{0.984} & 0.992 & 0.982 & \textbf{0.980} \\
SVM                 & \textbf{0.984} & \textbf{0.993} & \textbf{0.983} & 0.979 \\
\end{tabular}
\end{center}
\end{table}
...
LogisticRegression  & \textbf{0.984} & 0.991 & 0.982 & 0.983 \\
SVM                 & \textbf{0.984} & \textbf{0.993} & \textbf{0.983} & \textbf{0.984} \\
\end{tabular}
\end{center}
\end{table}
